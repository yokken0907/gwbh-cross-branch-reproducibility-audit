...
Optional post-closure review assets supplied with the v1.1.0 candidate:
...
Historical U03 RUN01 remains a formal `NO_GO_NUMERIC_COMPLETE_FRAME_LT8`. The corrected U03 calibration and XR01 transport are separately versioned analyses and must not be used to reclassify that result or the B07 closure.
