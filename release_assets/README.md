...
The published v1.0.0 Release consists of A01 and A02 plus their `.sha256` sidecars. Those identities remain immutable. The v1.1.0 source candidate additionally references independently versioned post-closure review assets A03 and A04. Large ZIP files belong in a GitHub Release or review bundle, not in the ordinary Git tree.
...
- Role: complete self-verifying archive for the corrected all-22 retrospective summary-screening calibration, including the immutable historical RUN01 gate-stop references.
- Historical closure effect: `NONE`.

## A04 — GWTC-4.1 XR01 conceptual transport
...
- Role: complete self-verifying archive for the all-44 target-value-blind conceptual transport and its formal next-step `NO_GO` decision.
- Historical closure effect: `NONE`.
